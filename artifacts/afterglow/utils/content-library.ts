...
export const ORACLE_LIBRARY: Record<string, string[]> = {
  ...
  loves_me: [
    ...
    "{{p}}'s {{pMoon}} emotional style means they tend to feel more than they say, and they express more through behaviour than words. If you're looking for declarations, you might be looking in the wrong direction. Look at what they do when you need something. Look at how they show up when it's inconvenient. That's where this personality type speaks.",
    "Your emotional style — {{uMoonStyle}} — and {{p}}'s — {{pMoonStyle}} — are both carrying something. The foundation underneath the feeling is {{gunaVerdict}}. The question you're actually asking is: is what I feel anchored in something real, or am I building on sand? The ground exists. What you build on it is still your choice.",
  ...
  come_back: [
    ...
    "{{p}}'s emotional pattern is {{pNakPattern}}. That pattern has a specific relationship with return — there's often a tendency to go back to what felt real, sometimes past the point where it makes sense. The question isn't whether they'll come back. It's: if they did, what would need to be specifically different? Write that down. That's the only version of a return worth wanting.",
    "Your compatibility shows {{gunaVerdict}}. At that level, endings rarely feel complete — because they aren't, entirely. The connection persists. But that isn't an instruction — it's an invitation to do something different with what was left unresolved. Your current phase asks: what do you want to build, with or without {{p}}? The answer to that determines whether return becomes something worth having.",
  ...
  compatible: [
    "Your overall compatibility: {{gunaVerdict}}. The summary matters less than the specifics — where things flow naturally is where to build from, where they require effort is where to pay attention. Compatibility isn't a score — it's information about where to invest. The question isn't 'are we compatible' — it's 'are we choosing each other in the ways this connection needs?'",
    "Compatible doesn't mean easy. Your compatibility profile shows {{gunaVerdict}} — genuine emotional resonance in the areas that matter most for lasting connection. The friction areas are real too. What the overall picture actually measures: how much raw material exists for something real. What happens with that material is entirely your choice.",
  ...
  move_on: [
    "Your {{uMoon}} emotional style processes grief through {{uMoonStyle}}. That means the path through this isn't around it — it's through it. Your current phase — {{dashaPhase}} — isn't asking you to hurry. It's asking you to be honest about what you're actually grieving.",
    "Your emotional pattern — {{uNakPattern}}. That pattern in grief tends to hold on past the useful point. The attachment is real. So is the question: are you holding on to them, or to the version of yourself that existed in that connection? Those are different griefs and they need different things.",
  ...
  future: [
    "Your current phase — {{dashaPhase}} — shapes what's available to you right now. Connections that deepen in this kind of period tend to carry more weight. Whether that applies to {{p}} or to someone else depends on choices being made now.",
    "Your compatibility shows {{gunaVerdict}}. That's the read on long-term potential. But compatibility is a map, not the destination. The future depends on two ongoing choices: both people showing up honestly, and both people growing. The potential is there. The outcome is being decided continuously.",
  ...
  confused: [
    ...
    "Mixed signals from {{p}} usually mean they're genuinely mixed internally. A {{pMoon}} emotional style can want you and not be ready simultaneously — both things are true at once. The confusion isn't in their signal; it's in trying to get a single clear answer from someone who hasn't resolved the question themselves. Trust what you're sensing more than what you're being told.",
  ...
  red_flag: [
    "I hear this and want to take it seriously. Your {{uMoon}} emotional style senses safety — or its absence — with genuine accuracy. When that part of you registers alarm, it's not overthinking. It's pattern recognition working correctly. Your lived experience matters here. What specifically are you noticing? Not what you're afraid it means — what are you actually observing?",
    "Your emotional pattern gives you {{uNakStrength}}. When you're naming something as a red flag, that's your instincts doing their job. The harder question is whether you're willing to act on what you're seeing. The pull to stay, to give another chance, to explain it away — those are real. So is the signal. Both things can be true, and only one of them is reliable data.",
  ...
  general: [
    "Your {{uMoon}} emotional style is where your truth lives — and right now it's processing something that deserves attention. Your current phase — {{dashaPhase}} — tends to surface things that have been building underneath. What does your gut say about this situation, before the rationalisation starts? Start there.",
    "Your compatibility with {{p}} shows {{gunaVerdict}}. The friction area — {{weakKootaText}} — is where most of the unanswered questions live. Not where the love isn't, but where it needs support to move through. What would addressing that friction directly look like?",
