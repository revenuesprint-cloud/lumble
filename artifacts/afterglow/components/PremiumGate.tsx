...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontFamily: "PlusJakartaSans_700Bold", color: "#111827", textAlign: "center" },
  sub: { fontSize: 15, fontFamily: "PlusJakartaSans_400Regular", color: "#6B7280", textAlign: "center", lineHeight: 22 },
  ...
  perkText: { fontSize: 14, fontFamily: "PlusJakartaSans_400Regular", color: "#374151", flex: 1 },
  ...
  upgradeBtnText: { fontSize: 17, fontFamily: "PlusJakartaSans_700Bold", color: "#fff" },
  upgradePriceText: { fontSize: 12, fontFamily: "PlusJakartaSans_400Regular", color: "rgba(255,255,255,0.7)" },
  cancelBtn: { alignItems: "center", padding: 8 },
  cancelText: { fontSize: 14, color: "#9CA3AF", fontFamily: "PlusJakartaSans_400Regular" },
  ...
  successTitle: { fontSize: 24, fontFamily: "PlusJakartaSans_700Bold", color: "#111827" },
  successSub: { fontSize: 15, fontFamily: "PlusJakartaSans_400Regular", color: "#6B7280" },
});
